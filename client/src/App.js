...
import { Accordion, Card, CardTitle, Container, Button, Col, Row, Form, Modal, Image } from "react-bootstrap";
    ...
    <Col xl={3} >
      ...
      <Modal size="lg" show={show} onHide={handleClose} >
        <Modal.Header closeButton>
          <Modal.Title> Site: {props.value.site_id.value} <br /> Image Type: {props.value.image_type.value} <br /> Image Count: {props.value.doc_count}</Modal.Title>
        </Modal.Header>
        <Modal.Body> <Image src={img_url} width="765px" height="465px" /><br /><br /><br />
          <p>
